...
const App = () => {
  ...
  if (!playOnline) {
    return <div className='main-div'>
      <button onClick={onClickPlayOnline} className='play-online'>Play Tic Tac Toe</button>
    </div>
  }
  ...
  return (
    <div className='main-div'>
      ...
      <div>
        ...
        {finishedState && finishedState !== 'opponentLeftMatch' && finishedState === 'draw' && (
          <h3 className='finished-state'>the game is a draw!</h3>
        )}
      </div>
      ...
      {finishedState && finishedState === 'opponentLeftMatch' && (
        <h3 className='finished-state'>you won because your opponent left</h3>
      )}
    </div>
  )
}
